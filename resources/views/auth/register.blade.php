                        ...
                        <div class="col-lg-3 col-md-5 auth-form mx-auto my-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('register-user') }}" method="POST" enctype="multipart/form-data" id="regForm">
                                        @csrf
                                        ...
                                        <button type="submit" class="btn btn-pill btn-accent d-table mx-auto">Create
                                            Account</button>
                                    </form>
                                </div>
                            ...
                            <div class="auth-form__meta d-flex mt-4">
                                ...
                                <a class="ml-auto" href="{{ route('login-page') }}">Sign In?</a>
                            </div>
                        </div>
                    </div>
                </div>
