...
@endsection
@section('code')
<div class="rogan-hero-section-sec rogan-hero-section-v3 rogan-hero-section rogan-hero-five pt-150 pb-200 md-pt-100  pos-r">
    <div class="container">
    ...
    <div class="container">
       ...
       <div class="gl-vacancies">
          <div class="job-deatils">
             <h6>Group Product Manager -   <span>0 - 2 year experience</span></h6>
             <p>Getlead is looking for a Senior Business operation manager to join our growing Business Operation team for improving our external client facing processes and planning.
             </p>
          </div>
          <div class="apply-now">
       ...
       <div class="gl-vacancies">
          <div class="job-deatils">
             <h6>Graphic Designer -   <span>Fresher</span></h6>
             <p>Getlead is looking for a Senior Business operation manager to join our growing Business Operation team for improving our external client facing processes and planning.
             </p>
          </div>
          <div class="apply-now">
       ...
       <div class="gl-vacancies">
          <div class="job-deatils">
             <h6>UI/UX Designer -   <span>0 - 2 year experience</span></h6>
             <p>Getlead is looking for a Senior Business operation manager to join our growing Business Operation team for improving our external client facing processes and planning.
             </p>
          </div>
          <div class="apply-now">
       ...
       <div class="gl-vacancies">
          <div class="job-deatils">
             <h6>Web designer -   <span>Fresher</span></h6>
             <p>Getlead is looking for a Senior Business operation manager to join our growing Business Operation team for improving our external client facing processes and planning.
             </p>
          </div>
          <div class="apply-now">
       ...
       <div class="gl-vacancies">
          <div class="job-deatils">
             <h6>Laravel developer -   <span>Fresher</span></h6>
             <p>Getlead is looking for a Senior Business operation manager to join our growing Business Operation team for improving our external client facing processes and planning.
             </p>
          </div>
          <div class="apply-now">
       ...
       <div class="gl-vacancies">
          <div class="job-deatils">
             <h6>Marketing excecutive -   <span>Fresher</span></h6>
             <p>Getlead is looking for a Senior Business operation manager to join our growing Business Operation team for improving our external client facing processes and planning.
             </p>
          </div>
          <div class="apply-now">
