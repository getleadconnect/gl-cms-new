...
(function ($) {
  ...
  $(document).on('ready', function () {
     ...
     $(document).ready(function () {
        $(".testimonial-section-classic .testimonial-slider").slick({
           dots: true,
           infinite: true,
           speed: 300,
           arrows: false,
...
//    let currentIndex = 0;
//    let tabInterval = 6000;  
//    let autoSlide;
//    let slideTimeout;

//    function showNextTab() {
//        tabs[currentIndex].classList.remove('active');
//        document.querySelector(tabs[currentIndex].getAttribute('href')).classList.remove('show', 'active');
...
//        stopAutoSlide(); 
//        autoSlide = setInterval(showNextTab, tabInterval);
//    }
...
//        slideTimeout = setTimeout(startAutoSlide, tabInterval);
//    }
